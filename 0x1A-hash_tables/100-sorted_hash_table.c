...
/**
 * create_sht_node -function that  makes new sht node
 * @key: input value
 * @value:input value
...
/**
 * add_sht_node - function that adds node to sorted hash table
 * @ht: input value
 * @node: input value
...
/**
 * shash_table_get - function that retrieves the value of element with a given key in a...
 * @ht: input value
 * @key:input value
 *
...
/**
 * shash_table_print_rev - function that prints the elements of a sorted hash table in revers
 * @ht: input value
 */
